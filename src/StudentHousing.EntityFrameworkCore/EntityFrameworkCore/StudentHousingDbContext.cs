...
namespace StudentHousing.EntityFrameworkCore
{
    ...
    public class StudentHousingDbContext : 
        AbpDbContext<StudentHousingDbContext>,
        IIdentityDbContext,
        ITenantManagementDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            //{
            //    b.ToTable(StudentHousingConsts.DbTablePrefix + "YourEntities", StudentHousingConsts.DbSchema);

...
namespace StudentHousing.Migrations
{
    ...
    [Migration("20230610135442_addPropertyEnquiry")]
    partial class addPropertyEnquiry
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentHousing.Attachments.Attachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StudentHousing.Housing.Property", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int?>("DistanceFromUniversity")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PropertyLocationCoords")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("StudentHousing.Housing.PropertyEnquiry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("MessageFromStudent")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("PropertyEnquiry");
                });

            modelBuilder.Entity("StudentHousing.Housing.RegistrationNumber", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StudentHousing.Attachments.Attachment", b =>
                {
                    b.HasOne("StudentHousing.Housing.Property", null)
